...
const SignIn = () => {
  ...
  return (
    <AuthLayout
      title="Welcome Back"
      subtitle="Sign in to access exclusive deals and manage your upcoming adventures with ease."
      variant="signin"
    >
      <div className="space-y-6">
        ...
        <Button 
          variant="outline" 
          className="w-full h-12 text-base border-border hover:bg-muted hover:text-black"
