...
// interface BookSpeechToTextProps {
//     apiKey: string;
...
//     text: string;
//     onBookRoom: (details: any) => void;
// }

// export function BookSpeechToText({
//     text,
//     setText,
//     listening,
//     apiKey,
...
//                         content: `
//                             ${command}
//                             Determine if the user wants to book a room. 
//                             Respond with 'book' if the command is to book the room.
//                             If no action is determined, respond with 'unknown'.
//                         `,
//                     },
//                 ],
//             });
