                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                      ...
                      {errors?.maxNumberOfAdults?._errors[0] && (
                        <p className="text-red-500 text-sm mt-1">{errors.maxNumberOfAdults._errors[0]}</p>
                      )}
                    </div>
                    <div>
                      ...
                      {errors?.maxNumberOfChildren?._errors[0] && (
                        <p className="text-red-500 text-sm mt-1">{errors.maxNumberOfChildren._errors[0]}</p>
                      )}
                    </div>
                  </div>
                </div>
