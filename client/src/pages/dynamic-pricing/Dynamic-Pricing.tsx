...
import { fetchDynamicPricing } from "../dynamic-pricing/services";
import { fetchRoomTypesService } from "@/pages/inventory/services";
import type { IDynamicPricing } from "../dynamic-pricing/interface";
...
export default function DynamicPricing() {
    ...
    const [loader, setLoader] = useState<{ isLoading: boolean; message: string }>({
        isLoading: true,
