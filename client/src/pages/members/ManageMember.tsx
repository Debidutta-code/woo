...
import { User, Mail, Edit, CircleUserRound } from 'lucide-react';
import { z } from 'zod';
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <div className='flex'>
              ...
              {row.userName && (
                <p className="text-sm text-gray-500 flex items-center pl-5">
    ...
    },
    {
      ...
      render: (value: string) => (
        <Badge variant="outline">
          {value ? value.replace(/_/g, ' ').toLocaleUpperCase() : 'N/A'}
        </Badge>
      )
    },
    {
