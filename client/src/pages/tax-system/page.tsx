                        ...
                        {filteredTaxGroups.length === 0 ? (
                            <Card className="shadow-lg">
                                <CardContent className="p-12 text-center">
                                    ...
                                    {!searchQuery && access?.canCreateTaxGroup && (
                                        <Button
                                            onClick={() =>
                                                setTaxGroupDialog({
                                                    open: true,
                        ...
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                                {ratePlanActionDialog.action === "add"
                                    ? `Add "${ratePlans.find((rp) => rp.ratePlanCode === ratePlanActionDialog.ratePlanId)?.ratePlanName}" to "${taxGroups.find((g) => g.id === ratePlanActionDialog.selectedGroupId)?.name}"?`
                                    : `Remove "${ratePlans.find((rp) => rp.ratePlanCode === ratePlanActionDialog.ratePlanId)?.ratePlanName}" from "${taxGroups.find((g) => g.id === ratePlanActionDialog.selectedGroupId)?.name}"?`}
                            </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                            <AlertDialogCancel>Cancel</AlertDialogCancel>
