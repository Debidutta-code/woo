...
export class PropertyLoyalityService {
    ...
    public async createPropertyLoyalityConfig(
        ...
        try {
            ...
            if (
                activeExisting &&
                activeExisting.creationLoyaltyConfigId !=
    ...
    public async getPropertiesByLoyaltyProgram(
        ...
        try {
            const result =
                await this.propertyLoyalityRepository.getPropertiesByLoyaltyProgram(
                    loyaltyProgramId
                );
