...
import { PropertyCustomRequest,CustomRequest,errorResponse } from '../../../../../common/utils';

export class DeviceSpecificPromotionController {
    deviceSpecificPromotionService: DeviceSpecificPromotionService;

    constructor() {
        this.deviceSpecificPromotionService =
            new DeviceSpecificPromotionService();
    }
        ...
        try {
            ...
            if (!validFrom) {
                return res
                    ...
                    .json(
                        errorResponse(
                            'Promotion applicable start date is required'
                        )
                    );
            }
            ...
            if (!deviceType || deviceType.length === 0) {
                return res
                    ...
                    .json(
                        errorResponse(
                            'At least one device type is required for device-specific promotion'
                        )
                    );
            }
            ...
            if (!ratePlanId || !ratePlanCode) {
                return res
                    ...
                    .json(
                        errorResponse(
                            'Rate plan ID and code are required for device-specific promotion'
                        )
                    );
            }
            ...
            const result =
                await this.deviceSpecificPromotionService.createDeviceSpecificPromotion(
                    {
                        ...promotionData,
                        roomId: null,
    ...
    public async getDeviceSpecificPromotionsByProperty(
        ...
        try {
            ...
            const result =
                await this.deviceSpecificPromotionService.getDeviceSpecificPromotionsByProperty(
                    propertyId
                );
    ...
    public async getDeviceSpecificPromotionById(
        req: CustomRequest,
        res: Response
    ) {
        try {
            ...
            const result =
                await this.deviceSpecificPromotionService.getDeviceSpecificPromotionById(
                    promotionId
                );
            const status = result.success ? 200 : 400;
            return res.status(status).json(result);
    ...
    public async updateDeviceSpecificPromotion(
        ...
        try {
            ...
            const result =
                await this.deviceSpecificPromotionService.updateDeviceSpecificPromotion(
                    promotionId,
                    updateData
                );
            const status = result.success ? 200 : 400;
    ...
    public async deleteDeviceSpecificPromotion(
        req: CustomRequest,
        res: Response
    ) {
        try {
            ...
            const result =
                await this.deviceSpecificPromotionService.deleteDeviceSpecificPromotion(
                    promotionId
                );
            const status = result.success ? 200 : 400;
            return res.status(status).json(result);
