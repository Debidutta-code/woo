...
import { IApiResponse, errorResponse } from '../../../../common/utils';
...
export class DynamicPricingController {
    ...
    public async getDynamicPricing(
        ...
        try {
            ...
            const response =
                await this.dynamicPricingService.getDynamicPricingByPropertyId(
                    propertyId
                );
            ...
            return res
                .status(500)
                .json(errorResponse('Failed to fetch Dynamic Pricing'));
        }
    }
}
