import { CurrencyCode, DiscountType, PostingRhythm, TaxApplicableOn, TaxType } from "../../../../../prisma/generated/prisma/enums";
...
import { IAddonAvailability } from "../../reservation-pricing/types";
import { IChildAddon, IPolicy } from "./repository.types";
import { IRoomPrice, ITouristTax } from "./room.type";
