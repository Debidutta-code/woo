...
export default class AccessDao {
    public static async createAccess(data: IUserRolesAndAccess) {
        try {
            ...
            throw new Error(
                `Failed to create access control: ${error.message}`
            );
        }
    }

    public static async getAccessByRole(
        role:
            | 'super_admin'
            | 'group_manager'
            | 'hotel_manager'
        ...
        try {
            ...
            throw new Error(
                `Failed to fetch access for role ${role}: ${error.message}`
            );
        }
    }
    ...
    public static async getAllAccess() {
        try {
            ...
            throw new Error(
                `Failed to fetch all access controls: ${error.message}`
            );
        }
    }

    public static async modifyAccess(
        role:
            | 'super_admin'
            | 'group_manager'
            | 'hotel_manager'
    ...
    public static async roleExists(
        role:
            | 'super_admin'
            | 'group_manager'
            | 'hotel_manager'
    ...
    public static async toggleRoleActive(
        role:
            | 'super_admin'
            | 'group_manager'
            | 'hotel_manager'
        ...
        try {
            ...
            throw new Error(
                `Error toggling role active status: ${error.message}`
            );
        }
    }
}
