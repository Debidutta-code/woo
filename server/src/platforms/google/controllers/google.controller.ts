...
export class GoogleFeedsController {
  ...
  public static async getLandingPageFeed(req: Request, res: Response) {
    ...
    //   console.log('🔗 Generating Landing Page Feed...');
      ...
      const landingPages = await GoogleFeedsService.generateLandingPageFeed();
      const xml = GoogleFeedsXMLBuilder.buildLandingPageFeed(landingPages);
  ...
  public static async getFeedStatus(req: Request, res: Response) {
    try {
      ...
      const propertyCount = await GoogleFeedsRepository.getActivePropertyCount();
