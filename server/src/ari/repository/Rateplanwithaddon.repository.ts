...
export class RatePlanWithAddonRepository {
  ...
  public static async addAddonToRatePlan(
    ...
    try {
      ...
      if (error instanceof Error) {
        throw new Error(`Failed to add addon to rate plan: ${error.message}`);
      }
      throw new Error('Unknown error occurred while adding addon to rate plan');
    }
  }
  ...
  public static async removeAddonFromRatePlan(
    ...
    try {
      ...
      if (error instanceof Error) {
        throw new Error(`Failed to remove addon from rate plan: ${error.message}`);
      }
      throw new Error('Unknown error occurred while removing addon from rate plan');
    }
  }
  ...
  public static async getAddonsByRatePlanCode(
    ...
    try {
      ...
      if (error instanceof Error) {
        throw new Error(`Failed to fetch addons for rate plan: ${error.message}`);
      }
      throw new Error('Unknown error occurred while fetching addons for rate plan');
    }
  }
  ...
  public static async getRatePlansByAddonId(
    ...
    try {
      ...
      if (error instanceof Error) {
        throw new Error(`Failed to fetch rate plans for addon: ${error.message}`);
      }
      throw new Error('Unknown error occurred while fetching rate plans for addon');
    }
  }
}