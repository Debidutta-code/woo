...
agentAuth.route("/login").post(agentAuthController.login.bind(agentAuthController));
agentAuth.route("/me")
    .get(partnerProtected, agentAuthController.getMe.bind(agentAuthController));
agentAuth.route("/logout").post(partnerProtected, agentAuthController.logout.bind(agentAuthController));
