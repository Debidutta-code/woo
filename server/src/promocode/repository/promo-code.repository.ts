...
import {
    ICReservationPromoCode,
    IReservationPromoCode,
...
export class PromoCodeRepository {
    ...
    public async decreasePromoCodeUsageCount(
        id: string
    ): Promise<IRPromoCode | null> {
        return await prisma.promoCode.update({
            where: {
    ...
    public async createReservationPromoCode(
        data: ICReservationPromoCode
    ): Promise<IReservationPromoCode> {
