...
export class PromoCodeController {
    ...
    public async createPromoCode(
        ...
        try {
            ...
            const result = await this.promoCodeService.createPromoCode({
                ...
                isApplicableForCorporate:
                    promoCodeData.isApplicableForCorporate,
    ...
    private validatePromoCodeData(
        ...
        if (
            promoCodeData.usageLimitPerUser &&
            promoCodeData.usageLimitPerUser < 0
        ) {
        ...
        if (
            promoCodeData.isApplicableForWalkIn === false &&
            promoCodeData.isApplicableForOTA === false &&
            promoCodeData.isApplicableForCorporate === false
        ) {
    ...
    public async updatePromoCode(
        ...
        try {
            ...
            const {
                promoCodeData,
            }: { promoCodeData: Partial<ICreatePromoCode> } = req.body;
            if (!id) {
                return res
                    .status(400)
