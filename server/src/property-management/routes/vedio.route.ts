...
vedioRouter.use("/property/:propertyId", protect, attachPropertyDetails({
    identifierType: "id",
    key: "propertyId",
    source: "params"
}), propertyVedioRouter);
...
propertyVedioRouter.route("/")
    ...
    .delete(propertyVedioController.deletePropertyVideo.bind(propertyVedioController));

// Room Video Endpoints
roomVedioRouter.route("/")
