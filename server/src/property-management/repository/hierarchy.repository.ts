...
export class UserDao {
  ...
  public static async getUsersByHierarchy(
    ...
    try {
      ...
      throw new Error(`Failed to get users by hierarchy: ${error.message}`);
    }
  }
  ...
  public static async getUsersUnderManagers(
    ...
    try {
      ...
      throw new Error(`Failed to get users under managers: ${error.message}`);
    }
  }
  ...
  public static async getAllUsersInHierarchy(
    ...
    try {
      ...
      throw new Error(`Failed to get all users in hierarchy: ${error.message}`);
    }
  }
}