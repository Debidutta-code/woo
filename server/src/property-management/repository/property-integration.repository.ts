...
export class PropertyIntegrationRepository {
    ...
    public async getActiveIntegrationByProperty(
        propertyId: string
    ): Promise<IPropertyIntegration | null> {
        try {
    ...
    public async toggleActiveIntegration(
        id: string,
        isActive: boolean
    ): Promise<IPropertyIntegration> {
        try {
    ...
    public async checkIfIntegrationExists(
        propertyId: string,
        masterIntegrationId: string
    ): Promise<IPropertyIntegration | null> {
        try {
...
export class PropertyIntegrationSecretsRepository {
    public async createIntegrationSecret(
        data: ICPropertyInregrationSecrets[],
        propertyIntegrationId: string
    ): Promise<IPropertyInregrationSecrets[]> {
        try {
            return await prisma.$transaction(
                data.map(secret =>
                    prisma.propertyInregrationSecrets.create({
                        data: {
                            ...secret,
    ...
    public async getById(
        id: string
    ): Promise<IPropertyInregrationSecrets | null> {
        try {
    ...
    public async updateIntegrationSecret(
        id: string,
        value: string
    ): Promise<IPropertyInregrationSecrets> {
        try {
    ...
    public async deleteIntegrationSecret(
        id: string
    ): Promise<IPropertyInregrationSecrets> {
        try {
    ...
    public async getAllByPropertyIntegrationId(
        propertyIntegrationId: string
    ): Promise<IPropertyInregrationSecrets[]> {
        try {
    ...
    public async addIntegrationSecret(
        data: ICPropertyInregrationSecrets,
        propertyIntegrationId: string
    ): Promise<IPropertyInregrationSecrets> {
        try {
