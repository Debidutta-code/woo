...
export class PropertyVideoRepository {
  public async addPropertyVideo(data:ICPropertyVideo):Promise<IPropertyVideo> {
  ...
  async updateVideo(propertyId: string, url:string,thumbnailUrl:string|null):Promise<IPropertyVideo | null> {
...
export class RoomVideoRepository {
  ...
  async updateVideo(roomId: string, url:string,thumbnailUrl:string|null):Promise<IRoomVideo | null> {
