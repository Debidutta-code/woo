...
router.route('/verify-reset-token').post(UserController.verifyResetToken);
router
    .route('/reset-password-with-token')
    .post(UserController.resetPasswordWithToken);
...
router.route('/me').get(protect, addRoleBasedDetails(), UserController.getMe);
router
