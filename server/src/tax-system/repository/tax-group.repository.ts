...
export class TaxGroupRepository {
    public async createTaxGroup(
        ...
        console.log(
            'Creating tax group for propertyId:',
            propertyId,
            'with data:',
            taxGroupData
        );
    ...
    public async getTaxGroupByPropertyId(
        propertyId: string
    ): Promise<ICTaxGroup[] | Error> {
        try {
    ...
    public async getTaxGroupById(
        taxGroupId: string
    ): Promise<ICTaxGroup | null | Error> {
        try {
