...
import { ActivityAction, ActivityEntity, ActivitySeverity, IChangeLog } from '../../modules/logs/model/activity.model';
import { ICreateActivityInput } from '../../modules/logs/types/types';
import { activityService } from '../../modules/logs/services/logs.services';
    ...
    private static async performLogging(
        ...
        try {
            ...
            const activityData: ICreateActivityInput = {
                ...
                propertyCode:
                    customReq.propertyCode || request.body?.propertyCode,
                propertyName:
                    customReq.propertyName || request.body?.propertyName,
                ...
                metadata: {
                    ...
                    requestId:
                        customReq.requestId || request.headers['x-request-id'],
