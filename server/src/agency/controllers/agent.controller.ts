        ...
        try {
            ...
            if (error instanceof Error) {
                return res
                    .status(500)
                    .json(
                        errorResponse('failed to create agent', error.message)
                    );
            }
            return res
                .status(500)
        ...
        try {
            ...
            if (error instanceof Error) {
                return res
                    .status(500)
                    .json(
                        errorResponse('failed to login agent', error.message)
                    );
            }
            return res
                .status(500)
    ...
    public async getAgentByEmail(
        ...
        try {
            ...
            if (error instanceof Error) {
                return res
                    .status(500)
                    .json(errorResponse('failed to get agent', error.message));
            }
            return res
                .status(500)
                .json(
    ...
    public async updateAgent(
        ...
        try {
            ...
            if (!id) {
                return res
                    .status(400)
                    .json(errorResponse('Agent id is required'));
            }
            ...
            if (error instanceof Error) {
                return res
                    .status(500)
                    .json(
                        errorResponse('failed to update agent', error.message)
                    );
            }
            return res
                .status(500)
        ...
        try {
            ...
            if (error instanceof Error) {
                return res
                    .status(500)
                    .json(
                        errorResponse('failed to delete agent', error.message)
                    );
            }
            return res
                .status(500)
    ...
    public async getAgents(
        ...
        try {
            ...
            if (error instanceof Error) {
                return res
                    .status(500)
                    .json(errorResponse('failed to get agents', error.message));
            }
            return res
                .status(500)
                .json(
