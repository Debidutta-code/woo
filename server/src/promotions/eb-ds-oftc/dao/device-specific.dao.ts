...
export class DeviceSpecificPromotionDao {
    public async createDeviceSpecificPromotion(
        ...
        try {
            ...
            if (error instanceof Error) {
                throw new Error(
                    `Failed to create device-specific promotion: ${error.message}`
                );
            }
            throw new Error(
                'Unknown error occurred while creating device-specific promotion'
            );
        }
    }
    public async getDeviceSpecificPromotionsByProperty(
        ...
        try {
            ...
            throw new Error(
                'Unknown error occurred while fetching device-specific promotions'
            );
        }
    }
    ...
    public async getDeviceSpecificPromotionById(
        ...
        try {
            ...
            throw new Error(
                'Unknown error occurred while fetching device-specific promotion'
            );
        }
    }
    ...
    public async updateDeviceSpecificPromotion(
        ...
        try {
            ...
            if (error instanceof Error) {
                throw new Error(
                    `Failed to update device-specific promotion: ${error.message}`
                );
            }
            throw new Error(
                'Unknown error occurred while updating device-specific promotion'
            );
        }
    }
    ...
    public async deleteDeviceSpecificPromotion(id: string): Promise<any> {
        try {
            ...
            if (error instanceof Error) {
                throw new Error(
                    `Failed to delete device-specific promotion: ${error.message}`
                );
            }
            throw new Error(
                'Unknown error occurred while deleting device-specific promotion'
            );
        }
    }
}
