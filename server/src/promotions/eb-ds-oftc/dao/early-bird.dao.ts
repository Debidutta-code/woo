...
export class EarlyBirdPromotionDao {
    public async createEarlyBirdPromotions(
        ...
        try {
            ...
            if (error instanceof Error) {
                throw new Error(
                    `Failed to create early-bird promotions: ${error.message}`
                );
            }
            throw new Error(
                'Unknown error occurred while creating early-bird promotions'
            );
        }
    }
    public async getEarlyBirdPromotionsByProperty(
        ...
        try {
            ...
            throw new Error(
                'Unknown error occurred while fetching early-bird promotions'
            );
        }
    }
    public async getEarlyBirdPromotionById(
        ...
        try {
            ...
            throw new Error(
                'Unknown error occurred while fetching early-bird promotion'
            );
        }
    }
    ...
    public async updateEarlyBirdPromotion(
        ...
        try {
            ...
            throw new Error(
                'Unknown error occurred while updating early-bird promotion'
            );
        }
    }
    ...
    public async deleteEarlyBirdPromotion(id: string): Promise<ICEbDsOftc> {
        try {
            ...
            throw new Error(
                'Unknown error occurred while deleting early-bird promotion'
            );
        }
    }
}
