...
export class OfferForTonightPromotionDao {
    public async createOfferForTonightPromotions(
        ...
        try {
            ...
            throw new Error(
                'Unknown error occurred while creating offer-for-tonight promotions'
            );
        }
    }
    ...
    public async getOfferForTonightPromotionsByProperty(
        ...
        try {
            ...
            throw new Error(
                'Unknown error occurred while fetching offer-for-tonight promotions'
            );
        }
    }
    ...
    public async getOfferForTonightPromotionById(
        ...
        try {
            ...
            throw new Error(
                'Unknown error occurred while fetching offer-for-tonight promotion'
            );
        }
    }
    ...
    public async updateOfferForTonightPromotion(
        ...
        try {
            ...
            throw new Error(
                'Unknown error occurred while updating offer-for-tonight promotion'
            );
        }
    }
    public async deleteOfferForTonightPromotion(id: string): Promise<any> {
        try {
            ...
            throw new Error(
                'Unknown error occurred while deleting offer-for-tonight promotion'
            );
        }
    }
}
