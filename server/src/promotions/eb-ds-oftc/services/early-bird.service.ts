...
export class EarlyBirdPromotionService {
    ...
    public async createEarlyBirdPromotion(
        ...
        try {
            ...
            const promotions =
                await this.earlyBirdPromotionDao.createEarlyBirdPromotions(
                    {
                        ...data,
                        currencyCode:
    ...
    public async getEarlyBirdPromotionsByProperty(
        ...
        try {
            const promotions =
                await this.earlyBirdPromotionDao.getEarlyBirdPromotionsByProperty(
                    propertyId
                );
    ...
    public async getEarlyBirdPromotionById(id: string): Promise<IApiResponse> {
        try {
            const promotion =
                await this.earlyBirdPromotionDao.getEarlyBirdPromotionById(id);
            ...
            return successResponse(
                'Early-bird promotion fetched successfully',
                promotion
            );
        } catch (error) {
            if (error instanceof Error) {
    ...
    public async updateEarlyBirdPromotion(
        ...
        try {
            ...
            const updatedPromotion =
                await this.earlyBirdPromotionDao.updateEarlyBirdPromotion(id, {
                    ...updateData,
                    currencyCode:
            ...
            if (updatedPromotion) {
                return successResponse(
                    'Early-bird promotion updated successfully',
                    updatedPromotion
                );
            } else {
    ...
    public async deleteEarlyBirdPromotion(id: string): Promise<IApiResponse> {
        try {
            ...
            const deletedPromotion =
                await this.earlyBirdPromotionDao.deleteEarlyBirdPromotion(id);

            if (deletedPromotion) {
                return successResponse(
                    'Early-bird promotion deleted successfully',
                    deletedPromotion
                );
            } else {
