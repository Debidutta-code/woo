import {
    ICEbDsOftc,
    IDeviceSpecificPromotion,
    IDeviceSpecificPromotionUpdate,
} from '../interfaces';
...
export class DeviceSpecificPromotionService {
    ...
    public async createDeviceSpecificPromotion(
        ...
        try {
            ...
            const promotion =
                await this.deviceSpecificPromotionDao.createDeviceSpecificPromotion(
                    {
                        ...data,
                        currencyCode:
            ...
            if (promotion) {
                return successResponse(
                    'Device-specific promotion created successfully',
                    promotion
                );
            } else {
                return errorResponse(
    ...
    public async getDeviceSpecificPromotionsByProperty(propertyId: string) {
        try {
            const promotions =
                await this.deviceSpecificPromotionDao.getDeviceSpecificPromotionsByProperty(
                    propertyId
                );
    ...
    public async getDeviceSpecificPromotionById(id: string) {
        try {
            const promotion =
                await this.deviceSpecificPromotionDao.getDeviceSpecificPromotionById(
                    id
                );
            ...
            return successResponse(
                'Device-specific promotion fetched successfully',
                promotion
            );
        } catch (error: any) {
            return errorResponse(
    ...
    public async updateDeviceSpecificPromotion(
        ...
        try {
            ...
            const updatedPromotion =
                await this.deviceSpecificPromotionDao.updateDeviceSpecificPromotion(
                    id,
                    {
                        ...updateData,
                        currencyCode:
            ...
            if (updatedPromotion) {
                return successResponse(
                    'Device-specific promotion updated successfully',
                    updatedPromotion
                );
            } else {
                return errorResponse(
    ...
    public async deleteDeviceSpecificPromotion(id: string) {
        try {
            ...
            const deletedPromotion =
                await this.deviceSpecificPromotionDao.deleteDeviceSpecificPromotion(
                    id
                );

            if (deletedPromotion) {
                return successResponse(
                    'Device-specific promotion deleted successfully',
                    deletedPromotion
                );
            } else {
                return errorResponse(
