...
import { IMLOS, IMLOSCreate } from '../interfaces';

export class MLOSDao {
    public async createRatePlanRule(data: IMLOSCreate): Promise<IMLOS> {
        try {
            ...
            throw new Error(
                'Unknown error occurred while creating rate plan rule'
            );
        }
    }
    ...
    public async getRatePlanRuleByRatePlanId(
        ...
        try {
            ...
            throw new Error(
                'Unknown error occurred while fetching rate plan rule'
            );
        }
    }
    ...
    public async updateRatePlanRule(
        ...
        try {
            ...
            throw new Error(
                'Unknown error occurred while updating rate plan rule'
            );
        }
    }
    ...
    public async deleteRatePlanRule(ratePlanId: string): Promise<IMLOS> {
        try {
            ...
            throw new Error(
                'Unknown error occurred while deleting rate plan rule'
            );
        }
    }

    public async ratePlanExists(
        ratePlanId: string
    ): Promise<IRatePlanFPromotions | null> {
        try {
            ...
            throw new Error(
                'Unknown error occurred while checking rate plan existence'
            );
        }
    }
    public async getRatePlanRulesByPropertyId(
        ...
        try {
            ...
            throw new Error(
                'Unknown error occurred while fetching rate plan rules'
            );
        }
    }
}
