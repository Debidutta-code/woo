...
export class SeasonalDynamicPricingService {
    ...
    public async createSeasonalDynamicPricing(
        ...
        try {
            ...
            return successResponse(
                'Seasonal dynamic pricing created successfully'
            );
        } catch (error) {
            if (error instanceof Error) {
                return errorResponse(
                    'Error creating seasonal dynamic pricing',
                    error.message
                );
            }
            return errorResponse(
    ...
    public async getSeasonalDynamicPricingByRoomId(
        ...
        try {
            const seasonalDynamicPricing =
                await this.seasonalRepo.getSeasonalDynamicPricingByRoomId(roomId);
            return successResponse(
                'Seasonal dynamic pricing retrieved successfully',
                seasonalDynamicPricing
            );
        } catch (error) {
            if (error instanceof Error) {
                return errorResponse(
                    'Error retrieving seasonal dynamic pricing',
                    error.message
                );
            }
            return errorResponse(
    ...
    public async updateSeasonalDynamicPricing(
        ...
        try {
            ...
            return successResponse(
                'Seasonal dynamic pricing updated successfully'
            );
        } catch (error) {
            if (error instanceof Error) {
                return errorResponse(
                    'Error updating seasonal dynamic pricing',
                    error.message
                );
            }
            return errorResponse(
    ...
    public async deleteSeasonalDynamicPricing(
        ...
        try {
            const existingSeasonalPricing =
                await this.seasonalRepo.getSeasonalDynamicPricing(id);
            ...
            return successResponse(
                'Seasonal dynamic pricing deleted successfully'
            );
        } catch (error) {
            if (error instanceof Error) {
                return errorResponse(
                    'Error deleting seasonal dynamic pricing',
                    error.message
                );
            }
            return errorResponse(
