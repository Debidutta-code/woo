...
export class DynamicPricing{
    public async getDynamicPricing(propertyId: string): Promise<IDynamicPricing | null> {
        try {
    ...
    public async getDynamicPricingByIdCO(id: string): Promise<IDynamicPricingOnly | null> {
        try {
    ...
    public async getDynamicPricingByPropertyIdCo(propertyId: string): Promise<IDynamicPricingOnly | null> {
        try {
            return await prisma.dynamicPricing.findFirst({
                where: { propertyId },
